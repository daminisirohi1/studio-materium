...
export const CATS: Record<Gender, CatalogCategory[]> = {
  men: [
    ...
    { id: 'indian-ethnic-men',name: 'Indian Ethnic',       parent: 'Heritage',     img: INDIAN_ETHNIC.banner,       tag: 'Kurta · Sherwani · Ethnic' },
    { id: 'japanese-traditions',name:'Japanese Traditions',parent: 'Heritage',     img: JAPANESE.banner,            tag: 'Kimono · Hakama · Martial Arts' },
    { id: 'knives',           name: 'Knives',              parent: 'Heritage',     img: KNIVES.banner,              tag: 'Fixed Blade · Folding · Ceremonial' },
    { id: 'swords',           name: 'Swords',              parent: 'Heritage',     img: SWORDS.banner,              tag: 'Katana · Sabre · Display' },
  ],
  women: [
    ...
    { id: 'indian-ethnic-w',  name: 'Indian Ethnic',       parent: 'Heritage',     img: INDIAN_ETHNIC.items[10],    tag: 'Saree · Lehenga · Salwar · Kurti' },
    { id: 'japanese-traditions-w', name: 'Japanese Traditions', parent: 'Heritage', img: JAPANESE.kimono.furisode, tag: 'Kimono · Hakama · Yukata' },
  ],
  kids: [
  ...
  formalwear: {
    ...
    storage: {
      ...
      blueprint: [
        ...
        { zone: 'Accessory Shelf', height: '30cm height', depth: '40cm depth', note: 'Bow ties, pocket squares, cufflinks tray' },
        { zone: 'Shoe Zone', height: '20cm per pair', depth: '35cm depth', note: 'Cedar shoe trees in every pair' },
      ],
    ...
    sections: [
      {
        title: 'Black Tie',
        items: [
          { name: 'Tuxedo', sub: 'Single-Breasted · Double-Breasted · Shawl Lapel · Peak Lapel', mat: 'Wool Barathea, Super 150s Wool, Wool-Silk Blend, Velvet', col: '#111,#1e1e3a,#3b1218,#004739', img: FORMAL.tuxedo[0], imgs: FORMAL.tuxedo.slice(0,3) },
          { name: 'Bow Tie', sub: 'Self-Tie Silk · Pre-Tied · Velvet · Knitted', mat: 'Silk Grosgrain, Satin Silk, Velvet, Knit Wool', col: '#111,#1e1e3a,#3b1218,#004739', img: FORMAL.ties[0], imgs: FORMAL.ties.slice(0,3) },
          { name: 'Dress Shoes', sub: 'Oxford Patent · Opera Pump · Patent Loafer', mat: 'Patent Leather, Calf Leather, Satin', col: '#111,#3b1218', img: FORMAL.dressShoe[0], imgs: FORMAL.dressShoe },
        ],
      },
      {
        title: 'White Tie',
        items: [
          { name: 'Tuxedo Jacket', sub: 'Peak Lapel · Shawl Lapel', mat: 'Super 150s Wool, Wool Barathea', col: '#111,#1e1e3a', img: FORMAL.tuxedo[3], imgs: FORMAL.tuxedo.slice(3,6) },
          { name: 'Evening Tie', sub: 'Silk · Satin · Velvet', mat: 'Silk, Satin, Velvet', col: '#111,#1e1e3a,#3b1218', img: FORMAL.ties[2], imgs: FORMAL.ties.slice(2,5) },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: 'Suits',
        items: [
          { name: 'Two Piece Slim Fit', sub: 'Super 120s Wool · Business / Office', mat: 'Super 120s Wool', col: '#3a3a3a,#1e1e3a,#111', img: SUITS.suits.twoPieceSlim },
          ...
          { name: 'Regular Fit Plain', sub: 'Wool · Business / Formal', mat: 'Wool', col: '#3a3a3a,#111,#1e1e3a', img: SUITS.suits.regularPlain },
          { name: 'Double-Breasted', sub: 'Wool-Cashmere · Boardroom / Formal', mat: 'Wool-Cashmere', col: '#1e1e3a,#111', img: SUITS.suits.doubleBreasted },
          ...
          { name: 'Classic Three-Piece', sub: 'Wool · Formal / Boardroom', mat: 'Wool', col: '#111,#3a3a3a', img: SUITS.suits.classicThreePiece },
        ],
      },
      {
        title: 'Blazers',
        items: [
          ...
          { name: 'Velvet Blazer', sub: 'Velvet · Evening / Cocktail', mat: 'Velvet', col: '#1e1e3a,#3b1218,#111', img: SUITS.blazers.velvet },
          { name: 'Double-Breasted Relaxed', sub: 'Stretch Wool · Smart Casual', mat: 'Stretch Wool', col: '#3a3a3a,#111', img: SUITS.blazers.doubleBreasted },
          { name: 'Jersey Knit', sub: 'Jersey · Travel / Casual', mat: 'Jersey Knit', col: '#111,#3a3a3a,#1e1e3a', img: SUITS.blazers.jerseyKnit },
          { name: 'Houndstooth', sub: 'Wool · Smart Casual / Autumn', mat: 'Wool Houndstooth', col: '#111,#ffffff', img: SUITS.blazers.houndstooth },
          { name: 'Linen Unstructured', sub: 'Linen · Summer / Casual', mat: 'Linen', col: '#c2b280,#ffffff,#3a3a3a', img: SUITS.blazers.linen },
          { name: 'Oversized Power Shoulder', sub: 'Structured Wool · Statement / Formal', mat: 'Wool', col: '#111,#3a3a3a,#1e1e3a', img: SUITS.blazers.powerShoulder },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: 'Mandarin Collar', sub: 'Regular Fit · Smart Casual / Occasion', mat: 'Cotton', col: '#ffffff,#3a3a3a,#111', img: SHIRTS.formal.mandarin },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Merino Polo Fine-Knit', sub: 'Fine Knit · Smart Casual / Travel', mat: 'Merino Wool', col: '#111,#3a3a3a,#c2b280', img: SHIRTS.polo.merinoPolo },
          { name: 'Performance Polo', sub: 'Athletic Fit · Sport / Active', mat: 'Performance Polyester', col: '#1e1e3a,#111,#ffffff', img: SHIRTS.polo.performancePolo },
        ],
      },
      {
        title: 'T-Shirts',
        items: [
          { name: 'Round Neck Solid', sub: 'Slim Fit · Casual / Everyday', mat: 'Cotton', col: '#ffffff,#111,#3a3a3a,#1e1e3a', img: SHIRTS.tshirts.solidSlim },
          { name: 'Round Neck Graphic', sub: 'Regular Fit · Casual / Streetwear', mat: 'Cotton', col: '#ffffff,#111,#3a3a3a', img: SHIRTS.tshirts.graphic },
          { name: 'V-Neck Slim', sub: 'Slim Fit · Smart Casual', mat: 'Cotton', col: '#ffffff,#111,#3a3a3a', img: SHIRTS.tshirts.vNeck },
          { name: 'Oversized Drop Shoulder', sub: 'Oversized · Streetwear / Casual', mat: 'Heavyweight Cotton', col: '#ffffff,#111,#3a3a3a', img: SHIRTS.tshirts.oversized },
          { name: 'Henley Long Sleeve', sub: 'Regular Fit · Smart Casual', mat: 'Cotton-Modal', col: '#111,#3a3a3a,#c2b280', img: SHIRTS.tshirts.henley },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: 'Oxford',
        items: [
          { name: 'Plain Cap Toe Oxford', sub: 'Classic · Black Tie / Business', mat: 'Calf Leather, Suede', col: '#111,#3b1218,#3a3a3a', img: FOOTWEAR.oxford.plainCapToe },
          ...
          { name: 'Semi-Brogue Oxford', sub: 'Business · Formal / Smart', mat: 'Calf Leather', col: '#111,#3b1218', img: FOOTWEAR.oxford.semiBrogue },
          { name: 'Whole-Cut Oxford', sub: 'Dress · Black Tie / Formal', mat: 'Calf Leather, Patent', col: '#111,#3b1218', img: FOOTWEAR.oxford.wholeCut },
        ],
      },
      {
        title: 'Loafer',
        items: [
          { name: 'Horsebit Loafer', sub: 'Smart Casual / Business', mat: 'Calf Leather, Suede', col: '#3b1218,#111,#c2b280', img: FOOTWEAR.loafer.horsebit },
          { name: 'Penny Loafer', sub: 'Smart Casual / Weekend', mat: 'Calf Leather, Suede', col: '#3b1218,#3a3a3a,#111', img: FOOTWEAR.loafer.penny },
          { name: 'Tassel Loafer', sub: 'Smart Casual / Business', mat: 'Calf Leather', col: '#3b1218,#111,#1e1e3a', img: FOOTWEAR.loafer.tassel },
        ],
      },
      {
        title: 'Monk Strap & Derby',
        items: [
          { name: 'Double Monk Strap', sub: 'Business / Smart', mat: 'Calf Leather, Suede', col: '#111,#3b1218,#3a3a3a', img: FOOTWEAR.monk.double },
          { name: 'Plain Derby', sub: 'Business / Formal', mat: 'Calf Leather', col: '#111,#3b1218', img: FOOTWEAR.derby.plain },
      ...
      },
      {
        title: 'Boots',
        items: [
          { name: 'Leather Chelsea Boot', sub: 'Smart Casual / Everyday', mat: 'Calf Leather', col: '#111,#3b1218', img: FOOTWEAR.chelsea.leather },
          ...
          { name: 'Stacked Heel Ankle Boot', sub: 'Casual / Fashion', mat: 'Leather, Suede', col: '#111,#3b1218', img: FOOTWEAR.ankle.stackedHeel },
        ],
      },
      {
        title: 'Casual Shoes',
        items: [
          { name: 'Canvas Low-Top Sneaker', sub: 'Casual / Everyday', mat: 'Canvas, Leather', col: '#ffffff,#111,#3a3a3a', img: FOOTWEAR.sneaker.canvasLow },
          { name: 'Dad Shoe', sub: 'Casual / Streetwear', mat: 'Mixed Upper', col: '#ffffff,#3a3a3a', img: FOOTWEAR.sneaker.dadShoe },
          { name: 'Leather Low-Top', sub: 'Smart Casual', mat: 'Leather', col: '#ffffff,#111', img: FOOTWEAR.sneaker.leatherLow },
          { name: 'Espadrille', sub: 'Casual / Summer / Resort', mat: 'Canvas, Jute', col: '#c2b280,#ffffff,#111', img: FOOTWEAR.espadrille.classic },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: 'Merino Polo', sub: 'Fine Knit · Golf / Smart Casual', mat: 'Merino Wool', col: '#111,#3a3a3a,#c2b280', img: GOLF.polo.merinoPolo },
          ...
          { name: 'Waterproof Shell Trousers', sub: 'Wet Weather · Golf', mat: 'Waterproof Shell', col: '#3a3a3a,#111', img: GOLF.trousers.waterproof },
      ...
      },
      {
        title: 'Footwear',
        items: [
          { name: 'Lace-Up Spiked Shoe', sub: 'Spiked · Traditional Golf', mat: 'Leather, Synthetic', col: '#ffffff,#3b1218,#111', img: GOLF.footwear.spiked },
          { name: 'BOA Closure Spikeless', sub: 'Spikeless · Versatile', mat: 'Leather, Synthetic', col: '#ffffff,#3a3a3a', img: GOLF.footwear.spikeless },
          { name: 'Winter Golf Boot', sub: 'Waterproof · Cold Weather', mat: 'Waterproof Leather', col: '#111,#3b1218', img: GOLF.footwear.boot },
        ],
      },
      {
        title: 'Equipment',
        items: [
          { name: 'Cart Bag', sub: '14-Divider · Golf', mat: 'Nylon', col: '#111,#3a3a3a,#1e1e3a', img: GOLF.equipment.cartBag },
          { name: 'Stand Bag', sub: 'Lightweight · Golf', mat: 'Nylon', col: '#3a3a3a,#111', img: GOLF.equipment.standBag },
          { name: 'Manual Push Trolley', sub: '3-Wheel · Golf', mat: 'Aluminium', col: '#3a3a3a,#111', img: GOLF.equipment.trolley },
        ],
      },
      {
        title: 'Accessories',
        items: [
          ...
          { name: 'Tour Cap', sub: 'Structured · Golf', mat: 'Cotton', col: '#111,#ffffff,#3a3a3a', img: GOLF.accessories.cap },
          { name: 'Classic Visor', sub: 'Golf / Sports', mat: 'Polyester', col: '#ffffff,#111', img: GOLF.accessories.visor },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: 'Apparel',
        items: [
          { name: 'Race Vest Singlet', sub: 'Race Fit · Road / Track', mat: 'Dry-Fit Polyester', col: '#1e1e3a,#111,#ffffff', img: RUNNING.apparel.singlet },
          { name: 'Short-Sleeve Dry-Fit', sub: 'Regular Fit · Training', mat: 'Dry-Fit Polyester', col: '#1e1e3a,#111,#3a3a3a', img: RUNNING.apparel.tshirtDry },
          { name: 'Merino Short-Sleeve', sub: 'Regular Fit · Trail / Comfort', mat: 'Merino Wool', col: '#c2b280,#3a3a3a,#111', img: RUNNING.apparel.tshirtMerino },
          { name: '5-Inch Split Short', sub: 'Performance · Road / Track', mat: 'Lightweight Polyester', col: '#1e1e3a,#111,#3a3a3a', img: RUNNING.apparel.shortsSplit },
          { name: '2-in-1 Short', sub: 'Training · Gym / Road', mat: 'Stretch Polyester', col: '#111,#3a3a3a', img: RUNNING.apparel.shorts2in1 },
          { name: '3/4 Running Tights', sub: 'Training · Cool Weather', mat: 'Compression Polyester', col: '#111,#1e1e3a', img: RUNNING.apparel.tights34 },
          { name: 'Full-Length Tights', sub: 'Cold Weather · Trail / Road', mat: 'Thermal Compression', col: '#111,#1e1e3a,#3a3a3a', img: RUNNING.apparel.tightsFull },
          { name: 'Packable Wind Jacket', sub: 'Packable · Road / Race', mat: 'Windproof Nylon', col: '#1e1e3a,#111,#3a3a3a', img: RUNNING.apparel.jackPackable },
          { name: 'Waterproof Shell Jacket', sub: 'Waterproof · Trail / Race', mat: 'Waterproof Nylon', col: '#3a3a3a,#111', img: RUNNING.apparel.jackWaterproof },
        ],
      },
      {
        title: 'Footwear',
        items: [
          ...
          { name: 'Carbon-Plated Racer', sub: 'Race Day · Road', mat: 'Carbon Plate, PEBA Foam', col: '#ffffff,#c9a96e', img: RUNNING.footwear.carbon },
          { name: 'Grip Trail Shoe', sub: 'Trail · Grip · Off-Road', mat: 'Vibram Rubber, Mesh', col: '#3a3a3a,#c2b280', img: RUNNING.footwear.trailGrip },
          { name: 'Waterproof Trail', sub: 'Gore-Tex · Wet Trail', mat: 'Gore-Tex, Mesh', col: '#3a3a3a,#111', img: RUNNING.footwear.trailWp },
        ],
      },
      {
        title: 'Accessories',
        items: [
          { name: 'Compression Socks', sub: 'Recovery · Road / Long Distance', mat: 'Nylon-Elastane', col: '#111,#1e1e3a,#ffffff', img: RUNNING.accessories.compression },
          { name: 'Low No-Show Socks', sub: 'Training · Road', mat: 'Cotton-Nylon', col: '#ffffff,#111', img: RUNNING.accessories.noShow },
          { name: 'Hydration Vest', sub: 'Trail · Long Run', mat: 'Nylon', col: '#3a3a3a,#111', img: RUNNING.accessories.vest },
          { name: 'GPS Training Watch', sub: 'GPS · Road / Trail / Track', mat: 'Silicone, Plastic', col: '#111,#3a3a3a', img: RUNNING.accessories.gpsWatch },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: 'Road Cycling',
        items: [
          { name: 'Short-Sleeve Race Jersey', sub: 'Race Fit · Road', mat: 'Lycra-Polyester', col: '#1e1e3a,#111,#ffffff', img: CYCLING.road.jerseyShort },
          { name: 'Long-Sleeve Thermal Jersey', sub: 'Winter · Road', mat: 'Thermal Lycra', col: '#111,#1e1e3a', img: CYCLING.road.jerseyLong },
          { name: 'Race Bib Short', sub: 'Race Fit · Road', mat: 'Lycra-Polyester', col: '#111,#1e1e3a', img: CYCLING.road.bibShortRace },
          { name: 'Endurance Bib Short', sub: 'Training · Road', mat: 'Lycra-Polyester', col: '#111,#3a3a3a', img: CYCLING.road.bibShortEnd },
          { name: 'Thermal Bib Tight', sub: 'Winter · Road', mat: 'Thermal Lycra', col: '#111', img: CYCLING.road.bibTight },
          { name: 'BOA Road Shoe', sub: 'Road · Racing', mat: 'Carbon Sole, Synthetic', col: '#ffffff,#111', img: CYCLING.road.shoesBoa },
          { name: 'Lace Road Shoe', sub: 'Road · Training', mat: 'Stiff Sole, Synthetic', col: '#ffffff,#3a3a3a', img: CYCLING.road.shoesLace },
          { name: 'Aero Road Helmet', sub: 'Road · Aerodynamic', mat: 'Polycarbonate, EPS', col: '#111,#ffffff,#1e1e3a', img: CYCLING.road.helmetAero },
          { name: 'Classic Ventilated Helmet', sub: 'Road · Training', mat: 'Polycarbonate, EPS', col: '#ffffff,#3a3a3a', img: CYCLING.road.helmetClassic },
          { name: 'Packable Wind Vest', sub: 'Road · Wind Protection', mat: 'Windproof Nylon', col: '#1e1e3a,#111', img: CYCLING.road.windVest },
        ],
      },
      {
        title: 'Mountain Biking',
        items: [
          { name: 'Trail Jersey', sub: 'MTB · Loose Fit', mat: 'Polyester', col: '#3a3a3a,#111,#c2b280', img: CYCLING.mtb.jersey },
          { name: 'Trail Baggy Short', sub: 'MTB · Casual', mat: 'Nylon', col: '#3a3a3a,#111', img: CYCLING.mtb.shortsBaggy },
          { name: 'DH Armoured Short', sub: 'Downhill · Protective', mat: 'Nylon, Foam Padding', col: '#111,#3a3a3a', img: CYCLING.mtb.shortsDH },
          { name: 'Clipless MTB Shoe', sub: 'MTB · Technical', mat: 'Synthetic, Rubber', col: '#111,#3a3a3a', img: CYCLING.mtb.shoeClipless },
          { name: 'Flat Pedal Shoe', sub: 'MTB · Sticky Rubber', mat: 'Synthetic, Rubber', col: '#3a3a3a,#111', img: CYCLING.mtb.shoeFlat },
          { name: 'Full-Face Helmet', sub: 'Downhill · Full Protection', mat: 'Fibreglass, EPS', col: '#111,#3a3a3a', img: CYCLING.mtb.helmetFull },
          { name: 'Open-Face Trail Helmet', sub: 'Trail · Ventilated', mat: 'Polycarbonate, EPS', col: '#111,#3a3a3a,#ffffff', img: CYCLING.mtb.helmetTrail },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: 'Athletic Fit Tee', sub: 'Tennis / Padel · Training', mat: 'Dry-Fit Polyester', col: '#ffffff,#111,#3a3a3a', img: TENNIS.apparel.tshirt },
          { name: '7-Inch Tennis Short', sub: 'Men · Tennis / Padel', mat: 'Stretch Polyester', col: '#ffffff,#111,#1e1e3a', img: TENNIS.apparel.shorts },
          { name: 'A-Line Tennis Dress', sub: 'Women · Tennis / Padel', mat: 'Stretch Polyester', col: '#ffffff,#1e1e3a', img: TENNIS.apparel.dress },
          { name: 'Pleated Skirt + Short', sub: 'Women · Tennis / Padel', mat: 'Stretch Polyester', col: '#ffffff,#111', img: TENNIS.apparel.skirt },
        ],
      },
      {
        title: 'Footwear',
      ...
      },
      {
        title: 'Equipment',
        items: [
          { name: 'Racket 97 sq.in', sub: '97 sq.in · Control · Advanced', mat: 'Graphite', col: '#111,#1e1e3a', img: TENNIS.equipment.racket97 },
          { name: 'Racket 100 Oversized', sub: '100 sq.in · Power · All Levels', mat: 'Graphite-Aluminium', col: '#3a3a3a,#111', img: TENNIS.equipment.racket100 },
          { name: 'Padel Racket Round Shape', sub: 'Control · All Levels', mat: 'Carbon-Fibre', col: '#3a3a3a,#c2b280', img: TENNIS.equipment.padelRacket },
          { name: '6-Racket Tennis Bag', sub: 'Padded · Travel', mat: 'Polyester', col: '#111,#1e1e3a,#3a3a3a', img: TENNIS.equipment.bag },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: 'Outer Layer',
        items: [
          { name: 'Hardshell Technical Jacket', sub: '3-Layer · Expert · Race', mat: 'Gore-Tex Pro', col: '#111,#1e1e3a,#3a3a3a', img: SKIING.outer.hardshell },
          ...
          { name: 'Luxury Down Shell Jacket', sub: 'Premium · Resort', mat: 'Down, Waterproof Shell', col: '#111,#ffffff,#c2b280', img: SKIING.outer.downShell },
          { name: 'Bib Salopette', sub: 'Full Coverage · Freeride', mat: 'Waterproof Nylon', col: '#111,#3a3a3a', img: SKIING.outer.salopetteBib },
          { name: 'Straight Salopette', sub: 'Classic · On-Piste', mat: 'Waterproof Shell', col: '#111,#1e1e3a,#3a3a3a', img: SKIING.outer.salopetteStraight },
        ],
      },
      {
        title: 'Mid Layers',
        items: [
          ...
          { name: 'Down + Fleece Hybrid', sub: 'Packable · Warmth', mat: 'Down, Fleece', col: '#111,#3a3a3a', img: SKIING.mid.hybrid },
        ],
      },
      {
        title: 'Base Layers',
        items: [
          { name: 'Merino Lightweight Top', sub: 'Base Layer · Comfort', mat: 'Merino Wool', col: '#ffffff,#3a3a3a,#111', img: SKIING.base.thermalTop },
          { name: 'Synthetic Midweight Top', sub: 'Base Layer · Performance', mat: 'Polyester', col: '#1e1e3a,#111,#3a3a3a', img: SKIING.base.thermalTopSyn },
      ...
      },
      {
        title: 'Footwear',
        items: [
          { name: 'Beginner Boot Flex 60–80', sub: 'Beginner · On-Piste', mat: 'Polyurethane', col: '#111,#3a3a3a', img: SKIING.footwear.bootBeginner },
          { name: 'Intermediate Boot Flex 90–110', sub: 'Intermediate · All-Mountain', mat: 'Polyurethane', col: '#111,#1e1e3a', img: SKIING.footwear.bootIntermediate },
          { name: 'Expert Boot Flex 120–130', sub: 'Expert · Race / Carving', mat: 'Polyurethane', col: '#111', img: SKIING.footwear.bootExpert },
      ...
      },
      {
        title: 'Headwear',
        items: [
          { name: 'MIPS In-Mould Helmet', sub: 'Safety · All-Mountain', mat: 'ABS, EPS', col: '#111,#3a3a3a,#ffffff', img: SKIING.headwear.helmetMips },
          { name: 'Spherical Mirrored Goggles', sub: 'Sun · Bright Conditions', mat: 'Polycarbonate', col: '#111,#c2b280', img: SKIING.headwear.gogglesMirror },
          { name: 'Photochromic Goggles', sub: 'Variable Light · All Conditions', mat: 'Polycarbonate', col: '#111,#3a3a3a', img: SKIING.headwear.gogglesPhoto },
        ],
      },
      {
        title: 'Accessories',
        items: [
          { name: 'Insulated Mitt', sub: 'Warmth · Powder / Cold', mat: 'Waterproof Nylon, Down', col: '#111,#3a3a3a', img: SKIING.accessories.mittInsulated },
          { name: 'Technical Glove', sub: 'Dexterity · On-Piste', mat: 'Goatskin, Waterproof', col: '#111,#3a3a3a', img: SKIING.accessories.gloveTech },
          { name: 'Midweight Ski Sock', sub: 'All-Mountain · Comfort', mat: 'Merino Wool-Nylon', col: '#3a3a3a,#111', img: SKIING.accessories.sockMid },
          { name: 'Thin Race Sock', sub: 'Racing · Speed Fit', mat: 'Merino Wool-Nylon', col: '#111', img: SKIING.accessories.sockRace },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: 'Boxing',
        items: [
          { name: '12oz Training Glove', sub: 'Training · Bag / Pad Work', mat: 'Leather, Synthetic', col: '#111,#3b1218,#1e1e3a', img: COMBAT.boxing.glove12 },
          { name: '16oz Sparring Glove', sub: 'Sparring · Contact', mat: 'Leather', col: '#111,#3b1218', img: COMBAT.boxing.glove16 },
          { name: 'Satin Boxing Short', sub: 'Training · Competition', mat: 'Satin Polyester', col: '#111,#3b1218,#1e1e3a', img: COMBAT.boxing.short },
          { name: 'High-Top Boxing Boot', sub: 'Competition · Ankle Support', mat: 'Leather, Synthetic', col: '#111,#3a3a3a', img: COMBAT.boxing.boot },
          { name: 'Cheek Guard Headguard', sub: 'Sparring · Protection', mat: 'Leather, Foam', col: '#111,#3b1218', img: COMBAT.boxing.headguard },
        ],
      },
      {
        title: 'Muay Thai',
        items: [
          { name: '10oz Muay Thai Glove', sub: 'Training · Muay Thai', mat: 'Leather, Synthetic', col: '#111,#3b1218,#1e1e3a', img: COMBAT.muayThai.glove },
          { name: 'Traditional Satin Short', sub: 'Competition · Training', mat: 'Satin Polyester', col: '#111,#3b1218,#1e1e3a', img: COMBAT.muayThai.short },
          { name: 'Full-Length Shin Pad', sub: 'Sparring · Protection', mat: 'Leather, Foam', col: '#111,#3b1218', img: COMBAT.muayThai.shinGuard },
        ],
      },
      {
        title: 'BJJ / MMA',
        items: [
          ...
          { name: 'MMA Tudo Short', sub: 'MMA / No-Gi · Training', mat: 'Stretch Polyester', col: '#111,#3b1218,#1e1e3a', img: COMBAT.bjj.mmaShort },
          { name: 'Long-Sleeve Rashguard', sub: 'No-Gi · Compression', mat: 'Spandex-Polyester', col: '#111,#1e1e3a,#3a3a3a', img: COMBAT.bjj.rashLong },
          { name: 'Short-Sleeve Rashguard', sub: 'No-Gi · Compression', mat: 'Spandex-Polyester', col: '#111,#1e1e3a', img: COMBAT.bjj.rashShort },
        ],
      },
      {
        title: 'Judo',
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'FIE 1600N Mask', sub: 'Competition · FIE Standard', mat: 'Steel Mesh', col: '#3a3a3a,#111', img: COMBAT.fencing.mask },
        ],
      },
      {
        title: 'Kendo',
        items: [
          { name: 'Cotton Kendogi', sub: 'Training · Traditional', mat: 'Heavy Cotton', col: '#1e1e3a,#111', img: COMBAT.kendo.kendogi },
          { name: 'Kendo Hakama', sub: 'Training · Traditional', mat: 'Tetron-Cotton', col: '#1e1e3a,#111', img: COMBAT.kendo.hakama },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: JEWELLERY.items.slice(0, 7).map((img, i) => ({
          ...
          sub: 'Fine · Occasion / Formal', mat: 'Gold, Silver, Platinum', col: '#c2b280,#111,#ffffff', img,
        })),
      },
      {
        ...
        items: JEWELLERY.items.slice(7, 14).map((img, i) => ({
          name: `Jewellery ${i + 8}`,
          sub: 'Casual · Everyday / Statement', mat: 'Silver, Gold-Fill, Steel', col: '#c2b280,#3a3a3a,#111', img,
        })),
      },
    ],
  },
    ...
    sections: [
      {
        title: "Men's Watches",
        items: [
          { name: 'Automatic Dress Watch', sub: 'Dress · Formal / Smart', mat: 'Steel Case, Leather Strap', col: '#c2b280,#111,#3a3a3a', img: WATCHES.men.autoDress },
          { name: 'Manual Wind Dress', sub: 'Dress · Heritage', mat: 'Steel Case, Leather Strap', col: '#111,#c2b280', img: WATCHES.men.manualDress },
          { name: 'Classic Chronograph', sub: 'Chronograph · Sport / Formal', mat: 'Steel Case, Leather Strap', col: '#111,#c2b280,#3a3a3a', img: WATCHES.men.classicChron },
          { name: 'Racing Chronograph', sub: 'Chronograph · Sport / Racing', mat: 'Steel Case, Rubber Strap', col: '#111,#3b1218,#3a3a3a', img: WATCHES.men.racingChron },
          { name: 'Diver Watch', sub: 'Sport · Water Resistant 300m', mat: 'Steel Case, Rubber Strap', col: '#111,#1e1e3a', img: WATCHES.men.diver },
          { name: 'Pilot / Aviation', sub: 'Sport · Heritage / Pilot', mat: 'Steel Case, Leather Strap', col: '#111,#3a3a3a,#c2b280', img: WATCHES.men.pilot },
        ],
      },
      {
        title: 'Smart Watches',
        items: [
          { name: 'GPS Multisport Watch', sub: 'Smart · Sports / Outdoor', mat: 'Titanium, Silicone', col: '#111,#3a3a3a', img: WATCHES.smart.gps },
          { name: 'Health & Sleep Tracker', sub: 'Smart · Wellness', mat: 'Aluminium, Silicone', col: '#111,#3a3a3a,#ffffff', img: WATCHES.smart.health },
        ],
      },
      {
        title: "Women's Watches",
        items: [
          { name: 'Fashion Strap Watch', sub: 'Casual · Everyday / Fashion', mat: 'Steel Case, Leather Strap', col: '#c2b280,#111,#3b1218', img: WATCHES.women.fashion },
          { name: 'Diamond Set Jewellery Watch', sub: 'Dress · Occasion / Formal', mat: 'Steel Case, Diamond Bezel', col: '#c2b280,#ffffff,#111', img: WATCHES.women.jewellery },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: "Men's Bags",
        items: [
          { name: 'Tech Backpack', sub: 'Daily · Work / Travel', mat: 'Nylon, Leather Trim', col: '#111,#3a3a3a', img: BAGS.men.techBackpack },
          { name: 'Leather Briefcase', sub: 'Formal · Office / Business', mat: 'Full-Grain Leather', col: '#3b1218,#111,#c2b280', img: BAGS.men.leatherBriefcase },
          { name: 'Slim Portfolio', sub: 'Formal · Meetings / Office', mat: 'Leather', col: '#111,#3b1218', img: BAGS.men.slimPortfolio },
      ...
      },
      {
        title: 'Sports Bags',
        items: [
          { name: 'Sports Backpack', sub: 'Active · Gym / Sport', mat: 'Nylon', col: '#111,#3a3a3a,#1e1e3a', img: BAGS.sports.sportsBackpack },
          { name: 'Large Gym Duffel', sub: 'Active · Gym / Sport', mat: 'Nylon', col: '#111,#3a3a3a', img: BAGS.sports.largeDuffel },
        ],
      },
      {
        title: 'Travel',
        items: [
          { name: 'Aluminium Trolley', sub: 'Carry-On · Business Travel', mat: 'Aluminium', col: '#3a3a3a,#c2b280,#111', img: BAGS.travel.alumTrolley },
          { name: 'Hard Shell Luggage', sub: 'Check-In · Travel', mat: 'Polycarbonate', col: '#111,#3a3a3a,#1e1e3a', img: BAGS.travel.luggage },
          { name: 'Leather Weekend Duffle', sub: 'Weekend · Travel / Gym', mat: 'Full-Grain Leather', col: '#3b1218,#111,#c2b280', img: BAGS.travel.leatherDuffle },
        ],
      },
      {
        title: "Women's Bags",
        items: [
          { name: 'Envelope Clutch', sub: 'Evening · Formal / Occasion', mat: 'Leather, Satin', col: '#c2b280,#111,#1e1e3a', img: BAGS.women.envelopeClutch },
          { name: 'Frame Clutch', sub: 'Evening · Cocktail / Formal', mat: 'Leather, Metal Frame', col: '#c2b280,#111', img: BAGS.women.frameClutch },
          { name: 'Small Crossbody', sub: 'Day · Casual / Smart', mat: 'Leather', col: '#3b1218,#111,#c2b280', img: BAGS.women.smallCrossbody },
          { name: 'Medium Shoulder Bag', sub: 'Day · Smart Casual / Work', mat: 'Leather', col: '#3b1218,#c2b280,#111', img: BAGS.women.mediumShoulder },
          { name: 'Canvas Tote', sub: 'Day · Casual / Beach', mat: 'Canvas, Leather Trim', col: '#ffffff,#3a3a3a,#c2b280', img: BAGS.women.canvasTote },
          { name: 'Leather Tote', sub: 'Work · Office / Smart', mat: 'Full-Grain Leather', col: '#3b1218,#111,#c2b280', img: BAGS.women.leatherTote },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: INDIAN_ETHNIC.items.slice(0, 8).map((img, i) => ({
          ...
          col: '#c2b280,#111,#3b1218,#1e1e3a,#004739',
          img,
        })),
      },
      {
    ...
    sections: [
      {
        title: 'Formal',
        items: [
          { name: 'Montsuki Haori Hakama', sub: 'Black 5-Mon Crest · Men · Formal Ceremony', mat: 'Silk', col: '#111', img: JAPANESE.formal.montsuki },
        ],
      },
      {
        title: 'Kimono',
        items: [
          ...
          { name: 'Kuro Tomesode', sub: 'Short Sleeve · Women · Formal Occasion', mat: 'Silk', col: '#111', img: JAPANESE.kimono.tomesode },
      ...
      },
      {
        title: 'Hakama',
        items: [
          { name: 'Pleated Hakama — Divided', sub: 'Men · Martial Arts / Ceremony', mat: 'Tetron-Cotton', col: '#1e1e3a,#111', img: JAPANESE.hakama.divided },
          { name: 'Pleated Hakama — Undivided', sub: 'Women · Ceremony', mat: 'Silk, Tetron', col: '#1e1e3a,#111,#c2b280', img: JAPANESE.hakama.undivided },
        ],
      },
      {
        title: 'Martial Arts',
        items: [
          ...
          { name: 'Kendogi + Hakama Set', sub: 'Kendo · Training / Competition', mat: 'Cotton, Tetron', col: '#1e1e3a,#111', img: JAPANESE.martialArts.kendoSet },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: 'Blazers',
        items: [
          { name: 'Oversized Power Shoulder', sub: 'Statement · Fashion / Work', mat: 'Wool', col: '#3a3a3a,#111', img: SUITS.blazers.powerShoulder },
          { name: 'Relaxed Double-Breasted', sub: 'Smart Casual · Day / Office', mat: 'Stretch Wool', col: '#c2b280,#3a3a3a,#111', img: SUITS.blazers.doubleBreasted },
          { name: 'Oversized Collarless DB', sub: 'Evening · Statement', mat: 'Wool', col: '#3a3a3a,#111,#1e1e3a', img: SUITS.blazers.powerShoulder2 },
          { name: 'Tailored Oversized Fit', sub: 'Smart Casual · Occasion', mat: 'Wool, Linen Blend', col: '#3a3a3a,#c2b280,#111', img: SUITS.blazers.doubleBreasted2 },
        ],
      },
    ],
  },
  ...
  'shirts-tops-w': {
    ...
    sections: [
      ...
      },
      {
        title: 'Tops',
        items: [
          { name: 'Satin Camisole', sub: 'Casual / Layering · Versatile', mat: 'Satin, Silk', col: '#c2b280,#111,#ffffff', img: SHIRTS.womenTops.camisole },
          { name: 'Fitted Crop Top', sub: 'Casual / Active', mat: 'Cotton, Jersey', col: '#111,#3a3a3a,#ffffff', img: SHIRTS.womenTops.cropTop },
          { name: 'Off-Shoulder Bodycon', sub: 'Evening · Fashion / Occasion', mat: 'Stretch Jersey', col: '#111,#3b1218,#1e1e3a', img: SHIRTS.womenTops.offShoulder },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: TROUSERS.skirts.slice(0, 8).map((img, i) => ({
          ...
          col: '#111,#3a3a3a,#c2b280,#1e1e3a,#ffffff',
          img,
        })),
      },
      {
        title: 'Trousers',
        items: [
          { name: 'Wide Leg Trousers', sub: 'Smart Casual · Office / Day', mat: 'Wool, Crepe', col: '#c2b280,#111,#3a3a3a', img: PANTS.wideLeg },
        ],
      },
      {
        title: 'Denim',
        items: [
          { name: 'Skinny Jeans', sub: 'Casual · Everyday', mat: 'Stretch Denim', col: '#1e1e3a,#3a3a3a,#111', img: PANTS.jeansW[0] },
    ...
    sections: [
      {
        ...
        items: DRESSES.items.slice(0, 7).map((img, i) => ({
          ...
          mat: 'Cotton, Linen, Jersey, Silk', col: '#c2b280,#111,#1e1e3a,#3b1218,#ffffff', img,
        })),
      },
      {
        ...
        items: DRESSES.items.slice(7, 14).map((img, i) => ({
          ...
          mat: 'Crepe, Silk, Satin, Chiffon', col: '#111,#1e1e3a,#3b1218,#c2b280', img,
        })),
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: JUMPSUITS.items.map((img, i) => ({
          ...
          mat: 'Crepe, Cotton, Linen, Silk, Satin', col: '#111,#3a3a3a,#c2b280,#1e1e3a,#ffffff', img,
        })),
      },
    ],
  },
    ...
    sections: [
      {
        title: 'Heels',
        items: [
          { name: 'Stiletto Classic Pump', sub: 'Formal · Evening / Business', mat: 'Leather, Suede', col: '#111,#3b1218,#c2b280', img: FOOTWEAR.heels.stiletto },
          { name: 'Mid Block Heel', sub: 'Smart Casual · Versatile', mat: 'Leather, Suede', col: '#111,#3b1218,#c2b280', img: FOOTWEAR.heels.blockHeel },
          { name: 'Kitten Heel Classic', sub: 'Smart · Office / Occasion', mat: 'Leather', col: '#111,#c2b280,#3b1218', img: FOOTWEAR.heels.kittenHeel },
          { name: 'Platform Pump', sub: 'Fashion · Statement', mat: 'Leather, Patent', col: '#111,#3b1218', img: FOOTWEAR.heels.platform },
          { name: 'Classic Wedge', sub: 'Casual / Smart · Summer', mat: 'Leather, Cork, Jute', col: '#c2b280,#3b1218,#111', img: FOOTWEAR.heels.wedge },
        ],
      },
      {
        title: 'Boots',
        items: [
          { name: 'Leather Chelsea Boot', sub: 'Smart Casual · Everyday', mat: 'Leather', col: '#111,#3b1218', img: FOOTWEAR.chelsea.leather },
          { name: 'Knee-High Riding Boot', sub: 'Heritage · Smart / Equestrian', mat: 'Leather', col: '#111,#3b1218', img: FOOTWEAR.knee.riding },
          { name: 'Stacked Heel Ankle Boot', sub: 'Casual / Fashion', mat: 'Leather, Suede', col: '#111,#3b1218', img: FOOTWEAR.ankle.stackedHeel },
        ],
      },
      {
        title: 'Casuals',
        items: [
          { name: 'Canvas Low-Top Sneaker', sub: 'Casual · Everyday', mat: 'Canvas', col: '#ffffff,#111,#3a3a3a', img: FOOTWEAR.sneaker.canvasLow },
          { name: 'Leather Low-Top', sub: 'Smart Casual', mat: 'Leather', col: '#ffffff,#111', img: FOOTWEAR.sneaker.leatherLow },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: 'Kuro Tomesode', sub: 'Married Women · Formal', mat: 'Silk', col: '#111', img: JAPANESE.kimono.tomesode },
  ...
  sections: [
    {
      ...
      items: JEWELLERY.items.slice(5, 12).map((img, i) => ({
        ...
        sub: 'Fine · Occasion / Formal', mat: 'Gold, Silver, Platinum, Diamond', col: '#c2b280,#ffffff,#111', img,
      })),
    },
    {
      title: 'Casual & Statement',
  ...
  sections: [
    {
      title: "Women's Bags",
      items: [
        { name: 'Leather Tote', sub: 'Daily · Work / Smart Casual', mat: 'Full-Grain Leather', col: '#3b1218,#111,#c2b280', img: BAGS.women.leatherTote },
        { name: 'Canvas Tote', sub: 'Everyday · Casual', mat: 'Canvas, Leather Trim', col: '#3a3a3a,#c2b280,#ffffff', img: BAGS.women.canvasTote },
        { name: 'Medium Shoulder Bag', sub: 'Daily · Smart Casual', mat: 'Leather', col: '#111,#3b1218,#c2b280', img: BAGS.women.mediumShoulder },
        { name: 'Small Crossbody', sub: 'Everyday · Casual / Smart', mat: 'Leather', col: '#3b1218,#111,#c2b280', img: BAGS.women.smallCrossbody },
        { name: 'Envelope Clutch', sub: 'Evening · Formal / Occasion', mat: 'Leather, Satin', col: '#c2b280,#111,#1e1e3a', img: BAGS.women.envelopeClutch },
        { name: 'Frame Clutch', sub: 'Evening · Cocktail / Occasion', mat: 'Metal Frame, Leather', col: '#c2b280,#111', img: BAGS.women.frameClutch },
      ],
    },
    {
      title: 'Travel',
      items: [
        { name: 'Aluminium Trolley', sub: 'Carry-On · Business Travel', mat: 'Aluminium', col: '#3a3a3a,#c2b280,#111', img: BAGS.travel.alumTrolley },
        { name: 'Hard Shell Luggage', sub: 'Check-In · Travel', mat: 'Polycarbonate', col: '#111,#3a3a3a,#1e1e3a', img: BAGS.travel.luggage },
        { name: 'Leather Weekend Duffle', sub: 'Weekend · Travel', mat: 'Full-Grain Leather', col: '#3b1218,#111,#c2b280', img: BAGS.travel.leatherDuffle },
      ],
    },
  ],
};
