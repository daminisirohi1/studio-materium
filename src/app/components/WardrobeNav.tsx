...
interface WardrobeNavProps {
  ...
  /** Category name shown as breadcrumb after the gender — TypePage passes this */
  categoryName?: string;
  onOpenTray?: () => void;
  /** Hide the Men / Women / Kids tabs — used on the TypePage */
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 0 }}>
          {showGenderTabs && GENDERS.map((g, i) => {
          ...
          {/* Breadcrumb arrow + category name when inside TypePage */}
          {categoryName && (
            <>
