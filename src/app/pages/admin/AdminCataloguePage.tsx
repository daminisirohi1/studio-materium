        ...
        {([
          ...
          <div key={section.label} style={{ marginBottom: 48 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 20, marginBottom: 20 }}>
              ...
              <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 9, letterSpacing: '0.2em', color: 'rgba(255,255,255,0.25)' }}>{section.cats.length} categories</span>
            </div>
              ...
              {section.cats.map((cat, i) => (
                <motion.div key={cat.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.03 }}
                  ...
                  <div style={{ padding: '14px 16px' }}>
                    <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 7, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#c9a96e', marginBottom: 4 }}>{cat.parent}</div>
                    <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 15, fontWeight: 400, color: '#fff', marginBottom: 4 }}>{cat.name}</div>
                    <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 7.5, letterSpacing: '0.08em', color: 'rgba(255,255,255,0.3)', lineHeight: 1.4 }}>{cat.tag}</div>
                  </div>
                </motion.div>
              ))}
            </div>
